...
if("TRUE" STREQUAL "TRUE")
  set(fetch_navigation_SOURCE_PREFIX /home/jackmccann/fetch_ws/src/fetch_ros/fetch_navigation)
  set(fetch_navigation_DEVEL_PREFIX /home/jackmccann/fetch_ws/devel)
  ...
  set(fetch_navigation_INSTALL_PREFIX /home/jackmccann/fetch_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fetch_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jackmccann/fetch_ws/src/fetch_ros/fetch_navigation/${idir}'.  ${_report}")
    endif()
