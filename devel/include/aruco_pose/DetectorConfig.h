...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DetectorConfig::AbstractParamDescriptionConstPtr(new DetectorConfig::ParamDescription<int>("cornerRefinementMethod", "int", 0, "Corner refinement method", "{'enum_description': 'An enum to set corner refinement method', 'enum': [{'srcline': 33, 'description': 'No refinement', 'srcfile': '/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'CORNER_REFINE_NONE'}, {'srcline': 34, 'description': 'Do subpixel refinement', 'srcfile': '/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'CORNER_REFINE_SUBPIX'}, {'srcline': 35, 'description': 'Use contour-Points', 'srcfile': '/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'CORNER_REFINE_CONTOUR'}, {'srcline': 36, 'description': 'Use the AprilTag2 approach', 'srcfile': '/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'CORNER_REFINE_APRILTAG'}]}", &DetectorConfig::cornerRefinementMethod)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 33 "/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg"
      const int Detector_CORNER_REFINE_NONE = 0;
//#line 34 "/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg"
      const int Detector_CORNER_REFINE_SUBPIX = 1;
//#line 35 "/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg"
      const int Detector_CORNER_REFINE_CONTOUR = 2;
//#line 36 "/home/jackmccann/fetch_ws/src/aruco_pose/cfg/Detector.cfg"
