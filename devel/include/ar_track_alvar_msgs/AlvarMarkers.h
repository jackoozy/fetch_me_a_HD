...
struct AlvarMarkers_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::ar_track_alvar_msgs::AlvarMarker_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ar_track_alvar_msgs::AlvarMarker_<ContainerAllocator> >> _markers_type;
...
bool operator==(const ::ar_track_alvar_msgs::AlvarMarkers_<ContainerAllocator1> & lhs, const ::ar_track_alvar_msgs::AlvarMarkers_<ContainerAllocator2> & rhs)
{
