...
echo_and_run cd "/home/jackmccann/fetch_ws/src/fetch_ros/fetch_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/jackmccann/fetch_ws/src/fetch_ros/fetch_calibration/setup.py" \
     \
    build --build-base "/home/jackmccann/fetch_ws/build/fetch_ros/fetch_calibration" \
    install \
    --root="${DESTDIR-/}" \
