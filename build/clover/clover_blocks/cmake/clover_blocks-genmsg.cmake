...
set(MSG_I_FLAGS "-Iclover_blocks:/home/jackmccann/fetch_ws/src/clover/clover_blocks/msg")
...
get_filename_component(_filename "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Load.srv" NAME_WE)
add_custom_target(_clover_blocks_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "clover_blocks" "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Load.srv" ""
)

get_filename_component(_filename "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Store.srv" NAME_WE)
add_custom_target(_clover_blocks_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "clover_blocks" "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Store.srv" ""
)

get_filename_component(_filename "/home/jackmccann/fetch_ws/src/clover/clover_blocks/msg/Prompt.msg" NAME_WE)
add_custom_target(_clover_blocks_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "clover_blocks" "/home/jackmccann/fetch_ws/src/clover/clover_blocks/msg/Prompt.msg" ""
)

get_filename_component(_filename "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Run.srv" NAME_WE)
add_custom_target(_clover_blocks_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "clover_blocks" "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Run.srv" ""
)
...
_generate_msg_cpp(clover_blocks
  "/home/jackmccann/fetch_ws/src/clover/clover_blocks/msg/Prompt.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(clover_blocks
  "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Load.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/clover_blocks
)
_generate_srv_cpp(clover_blocks
  "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Run.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/clover_blocks
)
_generate_srv_cpp(clover_blocks
  "/home/jackmccann/fetch_ws/src/clover/clover_blocks/srv/Store.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/clover_blocks
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/clover_blocks)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/clover_blocks\")")
  # install generated code
  install(
